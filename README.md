...
> GIFs are auto-regenerated by CI when the CLI or tape scripts change. To record them locally, install [VHS](https://github.com/charmbracelet/vhs) and run `vhs assets/tapes/generate.tape`.
