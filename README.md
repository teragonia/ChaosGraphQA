...
A comprehensive benchmark for testing reasoning capabilities of Large Language Models using dynamically generated knowledge graphs. KGRB creates unique, randomized graphs and questions that cannot be gamed or memorized, providing authentic assessments of LLM reasoning abilities.
...
kgrb generate --generator-type multihop --complexity 2 --num-questions 10 --output benchmark.json
kgrb generate --generator-type hierarchical --complexity 3 --num-questions 5 --seed 42
kgrb generate --generator-type temporal --complexity 1 --num-questions 8 --verify
kgrb generate --generator-type weighted --complexity 4 --num-questions 6 --output weighted.json
kgrb generate --generator-type conflicting --complexity 2 --num-questions 7

# Show benchmark information
kgrb info benchmark.json

# List available LLM models
kgrb list-models

# Evaluate with different LLM providers
kgrb evaluate benchmark.json --model openai/gpt-4o-mini --output results.json
kgrb evaluate benchmark.json --model anthropic/claude-3.5-sonnet --output results.json  
kgrb evaluate benchmark.json --model gemini/gemini-1.5-flash --output results.json
kgrb evaluate benchmark.json --model huggingface/microsoft/DialoGPT-medium --output results.json

# Test LLM connection
kgrb test-model --model anthropic/claude-3.5-sonnet

# Advanced evaluation options
kgrb evaluate benchmark.json \
...
KGRB prevents gaming and memorization through several key design principles:
