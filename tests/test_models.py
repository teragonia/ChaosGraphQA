...
class TestEntity:
    ...
    def test_entity_creation(self):
        ...
        entity = Entity(id="test_entity_1", name="Test Entity", entity_type="person")
...
class TestRelationship:
    ...
    def test_relationship_creation(self):
        ...
        rel = Relationship(source="entity_1", target="entity_2", relation_type="knows")
    ...
    def test_relationship_with_weight(self):
        ...
        rel = Relationship(
            source="entity_1", target="entity_2", relation_type="friend_of", weight=0.8
        )
...
class TestKnowledgeGraph:
    ...
    def test_add_relationship_missing_entities(self):
        ...
        kg = KnowledgeGraph()
        rel = Relationship(
            source="missing_1", target="missing_2", relation_type="knows"
        )
    ...
    def test_graph_stats(self):
        ...
        entities = [
            Entity(id=f"e{i}", name=f"Entity {i}", entity_type="person")
            for i in range(3)
        ]
