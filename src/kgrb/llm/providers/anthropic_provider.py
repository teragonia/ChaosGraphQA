...
class AnthropicProvider(BaseLLMProvider):
    ...
    def format_question_prompt(self, question: str, context: Optional[str] = None) -> str:
        ...
        """
        if context:
            return f"""I'll analyze the given context to answer your question.
...
Let me work through this step-by-step and provide a clear, direct answer based on the context provided."""
        else:
            return f"""<question>
{question}
</question>
